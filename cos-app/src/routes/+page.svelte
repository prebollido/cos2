    ...
    <div class="flex flex-col items-center w-16 sm:w-25 md:w-50 lg:w-80 h-auto mx-auto">
        <div id="log-in" class="py-5 px-2 w-80">
            ...
            <input
                ...
                class="border rounded-3xl my-2 w-full"
                />
                <button on:click={log_in} class="rounded-3xl my-2 w-full bg-[#d9d9d9] text-lg sm:text-sm md:text-sm lg:text-base font-bold p-2 py-3 font-Inter">
                    Sign in to your account
                </button>
            <img src="/images/or_line.svg" alt="orl" class="w-16 sm:w-25 md:w-50 lg:w-80 h-auto mx-auto"/>
            <img src="/images/google_log.svg" alt="orl" class="w-16 sm:w-25 md:w-50 lg:w-80 h-auto mx-auto py-2"/>
        ...
        <div id="notice" class="rounded-3xl bg-[#FF9595] w-150 p-3 mt-5">
            <p class="text-xs sm:text-xs md:text-xs lg:text-xs text-center font-bold pl-2 font-Inter">
                Account expired or account does not exist
            </p>
        </div>
    </div>
</section>
